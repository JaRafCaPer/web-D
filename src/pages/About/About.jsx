  ...
  return (
    <>
      ...
      <div className="about-text">
        <h2 className="font-bold mb-4">Denko Swoboda - Abogado Consultor en Seguros</h2>
        <p className="leading-relaxed mb-4">
          Bienvenido a mi página web! Soy Denko Swoboda, abogado graduado de la Universidad de Cartagena,
          especializado en Derecho Administrativo con una maestría en Seguros y más de 14 años de experiencia.
          Mi práctica profesional abarca tanto la asesoría legal en seguros como la planificación patrimonial, 
          siempre con el objetivo de proporcionar seguridad y tranquilidad a mis clientes.
        </p>
        <p className="leading-relaxed mb-4">
          Desde la elaboración de pólizas personalizadas hasta la resolución de conflictos legales, 
          ofrezco un enfoque integral para asegurar que mis clientes se sientan respaldados en cada paso del camino.
          Entiendo que cada situación es única, por lo que adapto mis servicios a las necesidades específicas de 
          cada persona, brindando un enfoque cercano y efectivo.
        </p>
        <Modal
